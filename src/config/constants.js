...
// SAMP ban/unban log channels
const SAMP_BAN_LOG_CHANNEL_ID = process.env.SAMP_BAN_LOG_CHANNEL_ID || LOG_CHANNEL_ID;
const SAMP_UNBAN_LOG_CHANNEL_ID = process.env.SAMP_UNBAN_LOG_CHANNEL_ID || LOG_CHANNEL_ID; 
